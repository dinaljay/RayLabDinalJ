...
%Volume files
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/Improved_vs_Nonimproved/Pre_op/ROI/Improved/improv_volume_data.mat');
improv_volumes = cell2mat(improv_volumes);
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/Improved_vs_Nonimproved/Pre_op/ROI/Nonimproved/non_improv_volume_data.mat');
