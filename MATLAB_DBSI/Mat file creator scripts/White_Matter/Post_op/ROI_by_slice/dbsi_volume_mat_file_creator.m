...
%Volume files
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/Post_op/ROI_by_slice/Control/control_volume_data.mat');
control_volumes = cell2mat(control_volumes);
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/Post_op/ROI_by_slice/Mild_CSM/mild_csm_volume_data.mat');
mild_csm_volumes = cell2mat(mild_csm_volumes);
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/Post_op/ROI_by_slice/Moderate_CSM/mod_csm_volume_data.mat');
