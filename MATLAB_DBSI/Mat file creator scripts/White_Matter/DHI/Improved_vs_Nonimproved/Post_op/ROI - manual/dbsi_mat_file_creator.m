...
improv_subjects = [2,5,9,20,19,21,26,30,36,40,41,46]; %mJOA
...
non_improv_subjects = [3,12,18,23,24,27,28,45];  %mJOA
...
for i = 1:numel(dhi_features)
    ...
    for k = 1:numel(improv_subjects)
        ...
        for j = 1:numel(slices)
            ...
            dwi_file = fullfile(csm_path,subjectID,'/scan_2/dMRI_ZOOMit/',slice_num,'/all_volumes/dense/DHI_results_0.3_0.3_3_3',param_file);
