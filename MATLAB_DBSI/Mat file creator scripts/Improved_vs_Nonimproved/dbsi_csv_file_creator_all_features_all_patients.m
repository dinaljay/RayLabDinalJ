...
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_b0_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_b0_map_data.mat');
b0 = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% DTI_ADC Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_dti_adc_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_dti_adc_map_data.mat');
dti_adc = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% DTI Axial Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_dti_axial_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_dti_axial_map_data.mat');
dti_axial = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% DTI FA Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_dti_fa_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_dti_fa_map_data.mat');
dti_fa = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% DTI Radial Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_dti_radial_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_dti_radial_map_data.mat');
dti_radial = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% Fiber Axial Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_fiber1_axial_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_fiber1_axial_map_data.mat');
fiber_axial = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% Fiber FA Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_fiber1_fa_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_fiber1_fa_map_data.mat');
fiber_fa = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

% Fiber Radial Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_fiber1_radial_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_fiber1_radial_map_data.mat');
...
% Water Fraction Map
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_water_fraction_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_water_fraction_map_data.mat');
water_fraction = [cell2mat(data_improv);cell2mat(data_non_improv)];
clear data_improv; clear data_non_improv;

%Axon volume
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_axon_volume_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_axon_volume_data.mat');
...
%Inflammation volume
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Improved/improv_inflammation_volume_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/Improved_vs_Nonimproved/Nonimproved/non_improv_inflammation_volume_data.mat');
...
out_dir = '/media/functionalspinelab/RAID/Data/Dinal/Pycharm_Data_improv_vs_nonimprov';
