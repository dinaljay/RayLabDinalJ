...
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/ROI/Control/control_b0_map_data.mat');
load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/ROI/CSM/csm_b0_map_data.mat');
...
for i = 1:size(csm_p_val,2)
    for j = 1:size(csm_p_val,1)
        csm_p_val(j,i) = round(csm_p_val(j,i),3,'significant');
        csm_tstat_val(j,i) = round(csm_tstat_val(j,i),3,'significant');
        csm_se_val(j,i) = round(csm_se_val(j,i),3,'significant');
    end
end
