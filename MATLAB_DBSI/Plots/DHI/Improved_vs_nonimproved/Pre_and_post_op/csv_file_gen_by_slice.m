...
for j = 1:numel(slices)
    ...
    %Axon volume
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Pre_op/ROI_by_slice/Improved/improv_axon_volume_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Pre_op/ROI_by_slice/Nonimproved/non_improv_axon_volume_data.mat');
    ...
    %Inflammation volume
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Pre_op/ROI_by_slice/Improved/improv_inflammation_volume_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Pre_op/ROI_by_slice/Nonimproved/non_improv_inflammation_volume_data.mat');
    ...
    %B0 map
    % load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_b0_map_data.mat');
    % load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_b0_map_data.mat');
    % b0 = [cell2mat(data_improv);cell2mat(data_non_improv)];
    % clear data_improv; clear data_non_improv;
    
    % DTI_ADC Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_dti_adc_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_dti_adc_map_data.mat');
    ...
    % DTI Axial Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_dti_axial_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_dti_axial_map_data.mat');
    ...
    % DTI FA Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_dti_fa_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_dti_fa_map_data.mat');
    ...
    % DTI Radial Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_dti_radial_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_dti_radial_map_data.mat');
    ...
    % Fiber Axial Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_fiber1_axial_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_fiber1_axial_map_data.mat');
    ...
    % Fiber FA Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_fiber1_fa_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_fiber1_fa_map_data.mat');
    ...
    % Fiber Radial Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_fiber1_radial_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_fiber1_radial_map_data.mat');
    ...
    % Fiber Fraction Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_fiber_fraction_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_fiber_fraction_map_data.mat');
    ...
    % Hindered Fraction Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_hindered_fraction_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_hindered_fraction_map_data.mat');
    ...
    % Restricted Fraction Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_restricted_fraction_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_restricted_fraction_map_data.mat');
    ...
    % Water Fraction Map
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_water_fraction_map_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_water_fraction_map_data.mat');
    ...
    %Axon volume
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_axon_volume_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_axon_volume_data.mat');
    ...
    %Inflammation volume
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Improved/improv_inflammation_volume_data.mat');
    load('/media/functionalspinelab/RAID/Data/Dinal/MATLAB_Data/DBSI/White_Matter/DHI/Improved_vs_Nonimproved/Post_op/ROI_by_slice/Nonimproved/non_improv_inflammation_volume_data.mat');
