...
#Clinical Data
url_clinical = '/home/functionalspinelab/Desktop/Dinal/DBSI_data/Clinical_data/csm_clinical_post.csv'
all_data_clinical = pd.read_csv(url_clinical, header=0)

all_data_clinical = all_data_clinical.drop(['record_id', 'Group_ID'], axis=1)
...
final.to_csv(r'/home/functionalspinelab/Desktop/Dinal/DBSI_data/dbsi_clinical_radiographic_data.csv', index=False, header=True)
