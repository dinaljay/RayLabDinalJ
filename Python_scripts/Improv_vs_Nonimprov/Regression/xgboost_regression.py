...
for n in range(len(improv_features)):
    ...
    #clf = GridSearchCV(XGBRegressor(), tuned_parameters, scoring='neg_mean_squared_error')
    #clf.fit(X_scaled, y)
    ...
    for i in range(len(X_scaled)):
        ...
        clf = XGBRegressor(n_estimators=10, colsample_bytree=0.3, learning_rate=0.1, max_depth=5, reg_alpha=10)
