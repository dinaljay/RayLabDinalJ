...
url = '/media/functionalspinelab/RAID/Data/Dinal/Pycharm_Data/White_Matter/DHIWhite_Matter/DHIWhite_Matter/DHI/Pycharm_Data_ROI_Voxel/Pre_op/all_patients_all_features_only_CSM_data.csv'
