...
radiographic_features = ["post_dti_adc", "post_dti_axial", "post_dti_fa", "post_dti_radial", "post_fiber1_axial", "post_fiber1_fa",
                         "post_fiber1_radial", "post_fiber_fraction", "post_hindered_fraction",
                         "post_nonrestricted_fraction", "post_restricted_fraction",
                         "post_water_fraction", "post_fiber1_extra_axial", "post_fiber1_extra_fraction", "post_fiber1_extra_radial",
...
for n in range(len(improv_features)):
    ...
    X = all_data.drop(['post_dti_adc', 'post_dti_axial', 'post_dti_fa', 'post_dti_radial'], axis=1)
