...
url = '/media/functionalspinelab/RAID/Data/Dinal/Pycharm_Data_ROI/DBSI_CSV_Data/all_patients_all_features_only_CSM_data.csv'

all_data = pd.read_csv(url, header=0)

X = all_data[['dti_adc_1', 'dti_adc_2', 'dti_adc_3', 'dti_adc_4', 'dti_axial_1', 'dti_axial_2', 'dti_axial_3',
             'dti_axial_4', 'dti_fa_1', 'dti_fa_2', 'dti_fa_3', 'dti_fa_4']]
y = all_data['Group_ID']
