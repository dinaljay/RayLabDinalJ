...
def train_test_model(hparams):
    ...
    tensorboard = TensorBoard(log_dir="/media/functionalspinelab/RAID/Data/Dinal/DNN_logs/binary/v1/{}".format(NAME))
        ...
        for activation in HP_ACTIVATION.domain.values:
            for dropout_rate in (HP_DROPOUT.domain.min_value, HP_DROPOUT.domain.max_value):
                for optimizer in HP_OPTIMIZER.domain.values:
                    ...
                    run('/media/functionalspinelab/RAID/Data/Dinal/DNN_logs/binary/v1/hparam_tuning/' + run_name, hparams)
                    session_num += 1
