...
flags.DEFINE_string(
    "logdir",
    "/home/functionalspinelab/Desktop/Dinal/Ray_lab_scripts/Python_scripts/Pre_op/DNN/Hyper_parameter_optimization/logs/v2",
...
HP_DENSE_LAYERS = hp.HParam("dense_layers", hp.IntInterval(1, 10))
